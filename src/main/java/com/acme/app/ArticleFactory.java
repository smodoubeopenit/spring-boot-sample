...
public class ArticleFactory {
    ...
    public static Article newArticle(String title, String author, String excerpt, String content) {
    ...
    public static Article newArticle(String title) {
        String excerpt = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.";
        ...
        return newArticle(title, "J. Doe", excerpt, content);
    }
